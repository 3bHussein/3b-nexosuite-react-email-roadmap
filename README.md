...
> **Goal:** Build visible proof, not only knowledge.  
> React UI + TypeScript/API + Email communication + GitHub workflow.
...
All HTML, CSS, and JavaScript are inside:
...
- Technical Product + Frontend Hybrid
